...
let
    aho_corasick_0_6_3_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    ascii_0_7_1_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "ascii";
      version = "0.7.1";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    bitflags_0_7_0_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "bitflags";
      version = "0.7.0";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    chrono_0_2_25_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "chrono";
      version = "0.2.25";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    chunked_transfer_0_3_1_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    conv_0_3_3_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "conv";
      version = "0.3.3";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    custom_derive_0_1_7_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    encoding_0_2_33_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "encoding";
      version = "0.2.33";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    encoding_index_japanese_1_20141219_5_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    encoding_index_korean_1_20141219_5_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    encoding_index_simpchinese_1_20141219_5_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    encoding_index_singlebyte_1_20141219_5_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    encoding_index_tradchinese_1_20141219_5_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    encoding_index_tests_0_1_4_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    log_0_3_8_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "log";
      version = "0.3.8";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    magenta_0_1_1_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "magenta";
      version = "0.1.1";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    magenta_sys_0_1_1_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    matches_0_1_6_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "matches";
      version = "0.1.6";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    num_0_1_40_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "num";
      version = "0.1.40";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    num_integer_0_1_35_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    num_iter_0_1_34_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "num-iter";
      version = "0.1.34";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    num_traits_0_1_40_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    rand_0_3_16_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "rand";
      version = "0.3.16";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    regex_0_2_2_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "regex";
      version = "0.2.2";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    regex_syntax_0_4_1_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    rustc_serialize_0_3_24_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    thread_local_0_3_4_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    tiny_http_0_5_8_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "tiny_http";
      version = "0.5.8";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    unreachable_1_0_0_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    url_0_2_38_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "url";
      version = "0.2.38";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    utf8_ranges_1_0_0_ = { dependencies?[], features?[] }: build-rust-package {
    ...
    uuid_0_1_18_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "uuid";
      version = "0.1.18";
      fractalType = "crate";
      src = pkgs.fetchzip {
    ...
    void_1_0_2_ = { dependencies?[], features?[] }: build-rust-package {
      crateName = "void";
      version = "1.0.2";
      fractalType = "crate";
      src = pkgs.fetchzip {
